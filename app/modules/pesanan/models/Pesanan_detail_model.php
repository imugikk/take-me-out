...
class Pesanan_detail_model extends Core_Model
{
    function __construct()
    {
        parent::__construct();
        $this->set_table('pesanan_detail');
        $this->set_pk('id_pesanan_detail');
        $this->set_log(false);
    }
    function count_list()
	{
        $this->db->select('count(tbl.id_pesanan_detail) as num_rows');
        if ($this->where)
		{
