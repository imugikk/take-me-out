<script type="text/javascript">
	...
	function page_setting_module(pg) {
        show_progress();
		$.post(site_url + 'setting.module/manage/page/' + pg, $('#filter_content').serialize(), function(result) {
	...
	function input(id) {
        show_progress();
		$.post(site_url + 'setting.module/manage/input/' + id, {}, function(result) {
			...
			buttons: {
				<?lang('yes');?>: {
					...
					action: function(){
						$.ajax({
							type:"POST",
							url:site_url+'setting.module/manage/delete',
							data:{id:id},
                            dataType: "json",
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader"><?lang('module');?></span>
                    <form class="ml-5" id="filter_content">
                        <div class="input-group input-group-sm input-group-solid" style="max-width: 175px">
                            <input type="text" class="form-control" name="f_search" onkeydown="if (event.keyCode == 13) page_setting_module(1);" placeholder="<?lang('search');?>" />
            ...
            <div class="d-flex align-items-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="javascript:void(0);" onclick="input();" class="btn btn-light-primary font-weight-bold ml-2">
                    <?lang('add');?>
                </a>
                <!--end::Button-->
            </div>
