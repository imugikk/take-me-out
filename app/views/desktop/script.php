...
<script src="<?= base_url();?>assets/custom/js/plugin.js" type="text/javascript"></script>
<script src="<?= base_url();?>assets/confirm/confirm.min.js" type="text/javascript"></script>
<!--end::Page Scripts-->
<script type="text/javascript">
    $(document).ready(function() {
        // load_content('dashboard/manage');
    });
</script>