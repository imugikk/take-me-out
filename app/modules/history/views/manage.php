<script type="text/javascript">
	...
	function page_Pesanan(pg) {
                show_progress();
                $.post(site_url + 'history/manage/page/' + pg, $('#filter_content').serialize(), function(result) {
	...
	function input(id) {
        showProgres();
		$.post(site_url + 'history/manage/input/' + id, {}, function(result) {
			...
			buttons: {
				Yes: {
					...
					action: function(){
						$.ajax({
							type:"POST",
							url:site_url+'history/manage/delete',
							data:{id:id},
                            dataType: "json",
