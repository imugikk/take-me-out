...
class Manage extends Core_Controller {
	...
	public function index()
	{
        ...
        if($language == "id"){
            $data['title'] = 'Data Master | Daftar ';
            $data['header'] = 'Data Master';
            $data['sub_header'] = 'Daftar Riwayat';
            $data['label_filter'] = 'Cari';
            $data['tombol_show'] = 'Tampilkan Filter';
        }elseif($language == "en"){
            $data['title'] = 'Data Master | History';
            $data['header'] = 'Data Master';
            $data['sub_header'] = 'History';
    ...
    function page($pg=1)
	{
		...
		$data['key'] = $filter;
		if($language == "id"){
            $data['title'] = 'Master Data | Riwayat';
            ...
            $data['title'] = 'Data Master | Riwayat';
            $data['header'] = 'Data Master';
            $data['sub_header'] = 'History';
            $data['label_filter'] = 'Search';
