<script type="text/javascript">
	...
	function page_flight(pg) {
        ...
        if(!kota_asal || !kota_tujuan){
            ...
            if(kota_asal == kota_tujuan){
                ...
                show_progress();
                $.post(site_url + 'flight/manage/page/' + pg, $('#filter_content').serialize(), function(result) {
    ...
    function pesan(id) {
        show_progress();
		$.post(site_url + 'flight/manage/pesan/' + id, {}, function(result) {
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5"><?lang('flight');?></h5>
                <!--end::Title-->
            </div>
            <!--end::Details-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="javascript:void(0);" onclick="page_flight(1);" class="btn btn-light-primary font-weight-bold ml-2">
                    Filter
                </a>
                <!--end::Button-->
            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="form-control" name="kota_asal" id="kota_asal">
                                            ...
                                            ?>
                                            <option value="<?=$row_asal['id_bandara'];?>">
                                                <?=$row_asal['nama_bandara'];?>
                                            </option>
                                            <?
                                            }
                                            ?>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select class="form-control" name="kota_tujuan" id="kota_tujuan">
                                            ...
                                            ?>
                                            <option value="<?=$row_tujuan['id_bandara'];?>">
                                                <?=$row_tujuan['nama_bandara'];?>
                                            </option>
                                            <?
                                            }
                                            ?>
